...
public class Constants {
	...
	public static final String BOOTSTRAP_SERVER_IP = "172.20.10.2";
	public static final int BOOTSTRAP_SERVER_PORT = 2001;
	
	public static final String NODE_IP = "172.20.10.2";
